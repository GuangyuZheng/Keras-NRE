...
if __name__ == "__main__":
    ...
    checkpointer = ModelCheckpoint(filepath=weights_file, monitor='val_loss', verbose=1, save_best_only=True,
                                   save_weights_only=True, mode='min')

    model.fit([train_words, train_pos1, train_pos2], train_y, batch_size=settings.big_num, epochs=settings.num_epochs,
              validation_split=0.01, initial_epoch=0, callbacks=[checkpointer])
